...
using WebZhurnal.Models.AccountViewModels;
using WebZhurnal.Services;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var identityClaim = new IdentityUserClaim<string> { ClaimType = "Type", ClaimValue = model.Type.ToString() };
                    user.Claims.Add(identityClaim);
                    var nameClaim = new IdentityUserClaim<string> { ClaimType = "Name", ClaimValue = model.Name };
